...
** Handles 3 cases:
**   1. Exact match (case-insensitive): "Carrer de Roc Boronat" == "carrer de roc boronat"
...
** Used to distinguish between "wrong number on valid street" vs "street not found".
...
** This is the minimum number of single-character edits (insert, delete, substitute)
...
**   5. If not, shows valid numbers for that street and asks the user to pick one
